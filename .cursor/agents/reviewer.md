...
7. MVP creep (chat, Whisper, shared transcript cache, Prisma, tRPC, Playwright, non-EN). Redis/BullMQ is in scope as the analysis queue + per-video lock (usage is Postgres).
